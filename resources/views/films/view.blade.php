		...
		<div class="container-fliud">
			<div class="wrapper row">
				...
				<div class="details col-md-6">
					...
					<h4 class="price">Ticket price: <span>{{ $film->price }}</span></h4>
					<h4 class="price">Release Date: <span>{{ $film->created_at }}</span></h4>
					...
					<div class="blog-comment">
						...
						<form method="post" action="{{ route('films.comment.store') }}">
				            ...
				            <div class="col-md-6 form-group">
				                <button type="submit" class="btn btn-primary">Commnet</button>&nbsp;&nbsp;<a href="{{url('films')}}" class="btn btn-success col-md-push-4 col-md-2 ">Cancel</a>
				            </div>
